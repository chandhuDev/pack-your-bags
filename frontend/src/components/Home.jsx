...
return (
    ...
    <div className="flex flex-row justify-evenly w-full h-128 md:mt-20 mt-10 ">
     ...
     <div className="grow h-full relative ">
      <div className='absolute md:top-1/4 top-32 right-2 md:left-80 z-10 md:h-3/5 md:w-2/6 h-32 w-32 bg-purple-400 rounded-full  bg-cover md:border-4 border-2 border-indigo-500/75 anime' style={{backgroundImage:`url(${Meghalaya})`}}>
      </div>
      <div className='absolute md:top-12 md:left-20 top-60 right-12 md:h-64 md:w-64 h-24 w-24 bg-yellow-400/40 rounded-full bg-cover md:border-4 border-2 border-indigo-500/75 anime' style={{backgroundImage:`url(${Gujarat})`}}>
      </div>
      <div className='absolute top-8 right-16  md:h-60 md:w-60 w-28 h-28 bg-green-400/70 rounded-full bg-cover md:border-4 border-2 border-indigo-500/75 anime' style={{backgroundImage:`url(${Rajasthan})`}}>
      </div>
      <div className='absolute md:bottom-4 bottom-16 md:right-16 right-12  md:h-48 md:w-48 w-24 h-24 bg-gray-500/70 rounded-full bg-cover md:border-4 border-2 border-lime-300/75 anime' style={{backgroundImage:`url(${Kerala})`}}>
      </div>
     </div>
   </div>
    </>
